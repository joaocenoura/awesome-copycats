...
run_once({ "unclutter -root",
           ...
           "xss-lock -- xscreensaver-command -lock" }) -- entries must be comma-separated
-- }}}
...
awful.layout.layouts = {
    ...
    -- extra https://github.com/copycat-killer/awesome-copycats/issues/173
...
--[[
    ...
    -- Brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("sudo cscrew-brightness --inc") end,
      {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("sudo cscrew-brightness --dec") end,
      {description = "-10%", group = "hotkeys"}),
    ...
    awful.key({ "Shift" }, "XF86AudioMute",
      ...
      {description = "play prev song", group = "hotkeys"}),
    ...
    awful.key({ }, "Print",
      function ()
        os.execute("screenshot --screen")
      end,
      {description = "print screen", group = "hotkeys"}),

    awful.key({ "Control" }, "Print",
      function ()
        os.execute("screenshot --window")
      end,
      {description = "print window", group = "hotkeys"}),

    awful.key({ "Control", "Shift" }, "Print",
      function ()
        os.execute("flameshot gui -p /home/joao/screenshots")
      end,
      {description = "print selection", group = "hotkeys"}),
